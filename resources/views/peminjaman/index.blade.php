...
<head>
    ...
    <title>Data Peminjaman — SiPinjamAlat</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .nav-item.active { background: linear-gradient(135deg, #1a56db, #1e429f); color: #fff; }
        ...
        .btn { padding: 6px 12px; border: none; border-radius: 8px; font-family: inherit; font-size: 12px; font-weight: 600; cursor: pointer; display: inline-flex; align-items: center; gap: 5px; transition: all 0.2s; }
        ...
        .alert-success { background: rgba(16,185,129,0.1); border: 1px solid rgba(16,185,129,0.3); border-radius: 12px; padding: 14px 18px; color: #059669; font-weight: 600; font-size: 14px; margin-bottom: 20px; display: flex; align-items: center; gap: 8px; }
    </style>
</head>
<body>
...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a class="nav-item active" href="{{ route('peminjaman.index') }}">
...
<div class="main">
    <div class="topbar">
        ...
        <div style="display:flex; align-items:center; gap:10px;">
            ...
            <span style="font-size:13px; font-weight:600; color:#334155;">{{ Auth::user()->name }}</span>
        </div>
    </div>
    ...
    <div class="content">
        ...
        <div class="section-card">
            <div class="section-title">
                <i class="fa-solid fa-handshake"></i> Semua Data Peminjaman
            </div>
